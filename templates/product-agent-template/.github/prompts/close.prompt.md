...
6. Vérifier que le verdict de vérification indépendante est enregistré pour les changements significatifs et qu'il provient d'une surface GitHub Copilot approuvée (voir `.github/copilot-instructions.md` et `docs/independent-verification.md`).

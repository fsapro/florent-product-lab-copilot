...
5. **Scaffold immédiat** : copier `templates/product-agent-template/` (README, `.github/copilot-instructions.md`, `.github/PULL_REQUEST_TEMPLATE.md`, `docs/product/plan.md` adapté au plan réel, `docs/decisions/`, `docs/learnings/`, `docs/independent-verification.md`, `docs/learning-lifecycle.md`) et pousser ce contenu en commit initial — avant toute création d'issue ou de milestone.

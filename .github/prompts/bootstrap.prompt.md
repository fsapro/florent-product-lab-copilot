...
5. **Scaffold immédiat** : copier `templates/product-agent-template/` (README, `.github/copilot-instructions.md`, `.github/PULL_REQUEST_TEMPLATE.md`, `.github/agents/`, `.github/skills/`, `.github/prompts/`, `.github/mcp.context7.example.json`, `docs/product/plan.md` adapté au plan réel, `docs/product/canvas.md`, `docs/solution-design/`, `docs/architecture/`, `docs/implementation-plan.md`, `docs/design-validation.md`, `docs/context7.md`, `docs/testing-strategy.md`, `docs/engineering-principles.md`, `docs/decisions/`, `docs/learnings/`, `docs/independent-verification.md`, `docs/tooling-policy.md`, `docs/learning-lifecycle.md`) et pousser ce contenu en commit initial — avant toute création d'issue ou de milestone. Lors de la copie des documents structurants (plan.md, solution-design.md, canvas.md), initialiser chaque table de version avec la ligne `| 1.0 | <date du jour> | Création | Bootstrap | — |` et le champ version à `"1.0"`.

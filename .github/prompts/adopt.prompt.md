...
5. **Scaffold idempotent.** Copier uniquement les fichiers du template absents du repository cible (`README.md`, `.github/copilot-instructions.md` si absent, `.github/PULL_REQUEST_TEMPLATE.md`, `.github/agents/`, `.github/prompts/` locaux, `.github/skills/`, `.github/mcp.context7.example.json`, `docs/solution-design/`, `docs/architecture/`, `docs/implementation-plan.md`, `docs/design-validation.md`, `docs/context7.md`, `docs/testing-strategy.md`, `docs/engineering-principles.md`, `docs/decisions/`, `docs/learnings/`, `docs/independent-verification.md`, `docs/tooling-policy.md`, `docs/learning-lifecycle.md`). Ne jamais écraser un fichier déjà présent (code, README métier, docs existants) sans confirmation explicite du PM.

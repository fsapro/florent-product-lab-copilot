...
5. **Scaffold idempotent.** Copier uniquement les fichiers du template absents du repository cible (`README.md`, `.github/copilot-instructions.md` si absent, `.github/PULL_REQUEST_TEMPLATE.md`, `.github/agents/`, `.github/prompts/` locaux, `.github/skills/`, `docs/solution-design/`, `docs/architecture/`, `docs/implementation-plan.md`, `docs/decisions/`, `docs/learnings/`, `docs/independent-verification.md`, `docs/learning-lifecycle.md`). Ne jamais écraser un fichier déjà présent (code, README métier, docs existants) sans confirmation explicite du PM. Les fichiers de principes d'ingénierie, tests et outillage sont couverts par la constitution spec-kit et ne font plus partie du scaffold.

...
6. Vérifier que le verdict de vérification indépendante est enregistré pour les changements significatifs et qu'il provient d'une surface GitHub Copilot approuvée (voir `docs/copilot/independent-verification.md` et `docs/copilot/tooling-policy.md`).
...
9. Évaluer la capitalisation : un apprentissage local mérite-t-il d'être créé ? (voir `docs/copilot/learning-lifecycle.md`)
10. Mettre à jour `projects.yaml` avec le statut `closed`.
11. Fournir la synthèse décisionnelle finale au PM.
